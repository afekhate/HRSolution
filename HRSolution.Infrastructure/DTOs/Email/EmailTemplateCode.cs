...
namespace HRSolution.Infrastructure.DTOs
{
    ...
    {
        public const string VATPAY_TOKEN = "VATPAY_TOKEN";
        public const string ACCOUNT_CREATION = "ACCOUNT_CREATION";
        public const string APPROVAL_REQUEST = "APPROVAL_REQUEST";
        public const string JOB_APPROVAL_REQUEST = "JOB_APPROVAL_REQUEST";
