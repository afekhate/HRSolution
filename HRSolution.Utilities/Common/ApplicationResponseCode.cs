    ...
    public class ApplicationResponseCode
    {
        ...
        private static List<ErrorMessage> ErrorMessageDataBank()
        {
            ...
            ;
                ...
                var data202 = new ErrorMessage
                {
                    Code = "202",
                    Name = "Your record was deactivated successfully"
                };
                listData.Add(data202);


                var data408 = new ErrorMessage
                {
                    Code = "408",
                    Name = "Error while saving to the database "
                };
                listData.Add(data408);
                ...
                var data809 = new ErrorMessage
                {
                    Code = "809",
                    Name = "Role does not exist"
                };
                listData.Add(data809);

                var data810 = new ErrorMessage
                {
                    Code = "810",
                    Name = "Unit does not exist"
                };
                listData.Add(data810);
                ...
                var data708 = new ErrorMessage
                {
                    Code = "708",
                    Name = "Your have a pending application under review"
                };
                listData.Add(data708);



                var data709 = new ErrorMessage
                {
                    Code = "709",
                    Name = "One of the Upload path is empty"
                };
                listData.Add(data709);
