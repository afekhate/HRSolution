...
namespace HRSolution.Utilities.Common
{
    ...
    {
        public const string Role = "RoleController";
        public const string CreateAction = "New Record Added";
    ...
    public class CommonResponseMessage
    {
        ...
        public const string BranchAdded = "Branch with branch code {0} was added successfully";
        public const string BranchExist = "Branch with {0} exist";
        public const string GenericError = "Error Occured while adding {0}";
        public const string OperationComplete = "Operation Completed at {0} with {1} records";
        public const string Successful = "Successful";

        public const string StaffAdded = "Staff with staff Id {0} was added successfully";
        public const string StaffExist = "Staff with staffId {0} exist";


        public const string MailSent = "{0} mail sent successfully to {1} at {2}";
        public const string MailNotSent = "{0} mail not sent to {1}";
        public const string MailUnavailable = "No unsent mail in the log at the moment ";
